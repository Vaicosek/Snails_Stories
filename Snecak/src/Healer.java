...
class Healer implements HeroTemplate {
    ...
    public Healer(int XP, int level, int HP) {
        this.XP = XP;
        this.level = level;
        this.HP = HP;
        abilities = new EnumMap<>(Healer.Ability.class);
        for (Healer.Ability ability : Healer.Ability.values()) {
